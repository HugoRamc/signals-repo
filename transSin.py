...
class transSin(object):
	
	def __init__(self):

		ventana = Tk()
		ventana.title("Transformada Función sin(t)")
		...
		lblTitulo = Label(ventana,text="Introduce los valores para graficar la Transformada de la función sin(t)")
		...
		self.btnGrafica = Button(ventana,text="Graficar",command=self.pintaSin)
